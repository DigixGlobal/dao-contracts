...
contract('Deployment Test', function (accounts) {
  ...
  describe('Deploy', function () {
    ...
    it('[Deploy multiSig]', async function () {
      ...
      multiSigWallet = await MultiSigWallet.new(addressOf.multiSigUsers, bN(2));
    ...
    it('[MultiSig removes original root]', async function () {
      ...
      await multiSigWallet.submitTransaction(contracts.daoIdentity.address, bN(0), data, { from: addressOf.multiSigUsers[0] });
