...
const daoConstantsKeys = function () {
  return {
    ...
    QUARTER_POINT_CLAIM_RESULT: 'quarter_point_claim_result',
    QUARTER_POINT_MILESTONE_COMPLETION: 'q_p_milestone_completion',
    REPUTATION_PER_EXTRA_QP: 'reputation_per_extra_qp',
    BONUS_REPUTATION_NUMERATOR: 'bonus_reputation_numerator',
    BONUS_REPUTATION_DENOMINATOR: 'bonus_reputation_denominator',
...
const daoConstantsValues = function (bN) {
  return {
    ...
    QUARTER_POINT_CLAIM_RESULT: bN(1),
    QUARTER_POINT_MILESTONE_COMPLETION: bN(3),
    REPUTATION_PER_EXTRA_QP: bN(5),
    BONUS_REPUTATION_NUMERATOR: bN(20),
    BONUS_REPUTATION_DENOMINATOR: bN(100),
    SPECIAL_PROPOSAL_COMMIT_PHASE: bN(1814400),
    SPECIAL_PROPOSAL_PHASE_TOTAL: bN(2419200),
