...
contract DaoConstants {
    ...
    bytes32 CONFIG_QUARTER_POINT_MILESTONE_COMPLETION_PER_10000ETH_PER_10000ETH = "q_p_milestone_completion";
...
contract DaoListingService is ResolverClient,
    ...
    /// @return _moderators list of moderator addresses
    ...
    /// @param _count number of addresses to list
    /// @param _from_start boolean, whether to list from start or end
    /// @return _participants list of participant addresses
    ...
    /// @return _proposals the list of proposal IDs
    ...
    /// @return _versions list of proposal versions
...
contract DaoConfigsStorage is ResolverClient, DaoConstants {
        ...
        public
    {
        ...
        uintConfigs[CONFIG_QUARTER_POINT_MILESTONE_COMPLETION_PER_10000ETH_PER_10000ETH] = 3;
        ...
        public
    {
        ...
        uintConfigs[CONFIG_QUARTER_POINT_MILESTONE_COMPLETION_PER_10000ETH_PER_10000ETH] = uintConfigs[23];
        ...
        returns (uint256[])
    {
        ...
        _uintConfigs[23] = uintConfigs[CONFIG_QUARTER_POINT_MILESTONE_COMPLETION_PER_10000ETH_PER_10000ETH];
