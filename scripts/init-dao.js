...
module.exports = async function () {
  ...
  await web3.eth.getAccounts(async function (e, accounts) {
    ...
    // console.log('finally = ', process.env.IPFS_HOST.concat(":").concat(process.env.IPFS_ENDPOINT_PORT));
    // console.log('finally = ', process.env.IPFS_HOST.concat(":").concat(process.env.HTTP_ENDPOINT_PORT).concat("/ipfs"));
    // dijixUtil.init('http://0.0.0.0:5001', 'http://0.0.0.0:9001/ipfs');
    // // dijixUtil.init(process.env.IPFS_HOST.concat(":").concat(process.env.IPFS_ENDPOINT_PORT),
    // //   process.env.IPFS_HOST.concat(":").concat(process.env.HTTP_ENDPOINT_PORT).concat("/ipfs"));
    // console.log('done init dijix');
